...
该信息抓取脚本为codex外接deepseek v4智能体构建
关键词为：
帮我设计并实现一个自动化工作流,要求:
业务功能:
1.触发:每天上午11:00(北京时间)自动运行
2.数据源:抓取 A股市场"AIAgent/智能体"概念板快成分股
3.筛选:按热度综合分(成交额40%+涨跌幅30%+资金净流入20%+新闻提及10%排序,取Top10
4.加工:为每只股票生成<50字摘要+当日关键新闻链接
5.推送:同步推送到任意chat平台:企业微信、飞书、钉钉、Telegram、邮件
## 1. 环境准备
### 1.1 确认 Python
